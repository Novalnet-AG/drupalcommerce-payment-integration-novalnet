...
/**
 * Provides the Novalnet postfinance card payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "novalnet_postfinancecard",
 *   label = "PostFinance Card",
 *   display_label = "PostFinance Card",
 *   forms = {
 *     "offsite-payment" = "Drupal\commerce_novalnet\PluginForm\NovalnetPostFinanceCard\NovalnetPostFinanceCardForm",
 *   }
 * )
 */
class NovalnetPostFinanceCard extends OffsitePaymentGatewayBase {
  private $code = 'novalnet_postfinancecard';
  /**
   * {@inheritdoc}
   */
  public function defaultConfiguration() {
    return [
      'mode' => 'live',
      'display_label' => t('PostFinance Card'),
  ...
  public function onReturn(OrderInterface $order, Request $request) {
    ...
    $order_state = $response['transaction']['status_code'] == 100 ? 'completed' : 'pending';
