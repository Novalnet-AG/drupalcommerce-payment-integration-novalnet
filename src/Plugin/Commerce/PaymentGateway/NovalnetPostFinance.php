...
/**
 * Provides the Novalnet postfinance payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "novalnet_postfinance",
 *   label = "PostFinance E-Finance ",
 *   display_label = "PostFinance E-Finance ",
 *   forms = {
 *     "offsite-payment" = "Drupal\commerce_novalnet\PluginForm\NovalnetPostFinance\NovalnetPostFinanceForm",
 *   }
 * )
 */
class NovalnetPostFinance extends OffsitePaymentGatewayBase {

  private $code = 'novalnet_postfinance';
  /**
   * {@inheritdoc}
   */
  public function defaultConfiguration() {
    return [
      'mode' => 'live',
      'display_label' => t('PostFinance E-Finance '),
