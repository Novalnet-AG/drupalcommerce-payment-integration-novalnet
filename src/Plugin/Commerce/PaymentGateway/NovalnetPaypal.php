...
class NovalnetPaypal extends OffsitePaymentGatewayBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $novalnet_library->commerceNovalnetGetManualChecklimit($form, $this->configuration, $this->code);
  ...
  public function onReturn(OrderInterface $order, Request $request) {
    ...
    $order_state = ($response['tid_status'] == 90) ? $this->configuration['order_pending_status'] : $this->configuration['order_completion_status'];
