...
/**
 * Provides the Novalnet Bancontact payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "novalnet_bancontact",
 *   label = "Bancontact",
 *   display_label = "Bancontact",
 *   forms = {
 *     "offsite-payment" = "Drupal\commerce_novalnet\PluginForm\NovalnetBancontact\NovalnetBancontactForm",
 *   }
 * )
 */
class NovalnetBancontact extends OffsitePaymentGatewayBase {
  private $code = 'novalnet_bancontact';
  /**
   * {@inheritdoc}
   */
