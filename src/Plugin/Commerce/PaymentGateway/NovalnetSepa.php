...
class NovalnetSepa extends OnsitePaymentGatewayBase {
  ...
  */
  ...
  public function createPayment(PaymentInterface $payment, $capture = true) {
    ...
    $request_parameters['customer'] = Novalnet::getCustomerData($order, $allow_b2b);
    ...
    $request_parameters['transaction']['due_date'] = date('Y-m-d', strtotime('+ ' . (!empty($this->configuration['novalnet_sepa_due_date'])
    ? $this->configuration['novalnet_sepa_due_date'] : 2). 'day'));
  ...
  */
  ...
  public function createPaymentMethod(PaymentMethodInterface $payment_method, array $payment_details) {
    ...
    ?$_POST['payment_information']['add_payment_method']['payment_details']:$_POST['payment_information']['add_payment_method'];
    \Drupal::service('session')->set('payment_details', $_POST['payment_information']['add_payment_method']['payment_details']);
    Novalnet::checkGuaranteeProcess($order, $this->code, $this->configuration, $birth_date);
