...
/**
 * Provides the Multibanco payment method type.
 *
 * @CommercePaymentMethodType(
 *   id = "novalnet_multibanco",
 *   label = @Translation("Multibanco"),
 *   create_label = @Translation("Multibanco"),
 * )
 */
class NovalnetMultibancoType extends PaymentMethodTypeBase {
