...
class NovalnetPostFinanceCardForm extends BasePaymentOffsiteForm {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['transaction'] =Novalnet::getTransactionData($order, $payment, $configuration);
    $request_parameters['transaction']['payment_type'] = Novalnet::getPaymentType('novalnet_postfinance_card');
