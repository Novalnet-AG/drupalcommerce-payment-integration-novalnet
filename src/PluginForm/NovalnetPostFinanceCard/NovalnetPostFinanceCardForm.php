<?php
/**
 * Contains the reirect payment form process.
 *
 ...
 * @version    1.2.0
 */
namespace Drupal\commerce_novalnet\PluginForm\NovalnetPostFinanceCard;
...
class NovalnetPostFinanceCardForm extends BasePaymentOffsiteForm {
  /**
   * {@inheritdoc}
   */
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['customer'] =  Novalnet::getCustomerData($order,'novalnet_postfinancecard');
    $request_parameters['transaction'] =Novalnet::getTransactionData($order,'novalnet_postfinancecard', $payment, $configuration);
    $request_parameters['transaction']['payment_type'] = Novalnet::getPaymentType('novalnet_postfinancecard');
