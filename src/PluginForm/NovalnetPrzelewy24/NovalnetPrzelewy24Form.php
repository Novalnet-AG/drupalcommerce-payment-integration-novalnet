 ...
 * @version    1.2.0
 */
namespace Drupal\commerce_novalnet\PluginForm\NovalnetPrzelewy24;
...
class NovalnetPrzelewy24Form extends BasePaymentOffsiteForm {
  /**
   * {@inheritdoc}
   */
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['customer'] = Novalnet::getCustomerData($order,'novalnet_przelewy24');
    $request_parameters['transaction'] = Novalnet::getTransactionData($order,'novalnet_przelewy24', $payment, $configuration);
    $request_parameters['transaction']['payment_type'] = Novalnet::getPaymentType('novalnet_przelewy24');
