...
/**
 * This is Przelewy24Form.
 */
class NovalnetPrzelewy24Form extends BasePaymentOffsiteForm {

  const NOVALNET_PRZELEWY_URL = 'https://payport.novalnet.de/globalbank_transfer';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['key'] = 78;
    $request_parameters['payment_type'] = 'PRZELEWY24';
    $paramlist = $novalnet_library->commerceNovalnetRedirectParameters($request_parameters, $novalnet_library->access_key, $order);
    return $this->buildRedirectForm($form, $form_state, self::NOVALNET_PRZELEWY_URL, $paramlist, 'post');
  }
