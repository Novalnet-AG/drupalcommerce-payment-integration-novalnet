...
/**
 * This is NovalnetIdealForm.
 */
class NovalnetIdealForm extends BasePaymentOffsiteForm {

  const NOVALNET_IDEAL_URL = 'https://payport.novalnet.de/online_transfer_payport';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['key'] = 49;
    $request_parameters['payment_type'] = 'IDEAL';
    $paramlist = $novalnet_library->commerceNovalnetRedirectParameters($request_parameters, $novalnet_library->access_key, $order);
    return $this->buildRedirectForm($form, $form_state, self::NOVALNET_IDEAL_URL, $paramlist, 'post');
  }
