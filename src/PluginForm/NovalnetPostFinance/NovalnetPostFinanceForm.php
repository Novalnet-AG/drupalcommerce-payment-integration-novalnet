 ...
 * @version    1.2.0
 */
namespace Drupal\commerce_novalnet\PluginForm\NovalnetPostFinance;
...
class NovalnetPostFinanceForm extends BasePaymentOffsiteForm {
  /**
   * {@inheritdoc}
   */
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['customer'] = Novalnet::getCustomerData($order,'novalnet_postfinance');
    $request_parameters['transaction'] = Novalnet::getTransactionData($order,'novalnet_postfinance', $payment, $configuration);
    $request_parameters['transaction']['payment_type'] =  Novalnet::getPaymentType('novalnet_postfinance');
