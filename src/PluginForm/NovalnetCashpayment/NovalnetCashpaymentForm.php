 ...
 * @version    1.0.1
 */
namespace Drupal\commerce_novalnet\PluginForm\NovalnetCashpayment;
...
/**
 * This is CashpaymentForm .
 */
class NovalnetCashpaymentForm extends BasePaymentMethodAddForm {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['payment_details']['display_title'] = $novalnet_library->commerceNovalnetDisplayPaymentLogo($configuration['display_label'], 'novalnet_cashpayment', $configuration);
    $description = $novalnet_library->commerceNovalnetGetDescription('novalnet_cashpayment');
