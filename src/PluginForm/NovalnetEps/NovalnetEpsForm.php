...
/**
 * This is EPS payment form.
 */
class NovalnetEpsForm extends BasePaymentOffsiteForm {

  const NOVALNET_EPS_URL = 'https://payport.novalnet.de/giropay';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['key'] = 50;
    $request_parameters['payment_type'] = 'EPS';
    $paramlist = $novalnet_library->commerceNovalnetRedirectParameters($request_parameters, $novalnet_library->access_key, $order);
    return $this->buildRedirectForm($form, $form_state, self::NOVALNET_EPS_URL, $paramlist, 'post');
  }
