...
/**
 * This is Novalnet Paypal form.
 */
class NovalnetPaypalForm extends BasePaymentOffsiteForm {

  const NOVALNET_PAYPAL_URL = 'https://payport.novalnet.de/paypal_payport';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $request_parameters['key'] = 34;
    $request_parameters['payment_type'] = 'PAYPAL';
    $paramlist = $novalnet_library->commerceNovalnetRedirectParameters($request_parameters, $novalnet_library->access_key, $order);
    return $this->buildRedirectForm($form, $form_state, self::NOVALNET_PAYPAL_URL, $paramlist, 'post');
  }
