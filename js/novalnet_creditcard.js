...
(function ($, Drupal) {
  'use strict';
	...
	getNovalnetHash: function(e){
		...
		if(jQuery("input[name='payment_information[add_payment_method][payment_details][pan_hash]']").val() != undefined && jQuery("input[name='payment_information[add_payment_method][payment_details][pan_hash]']").val() == '')
		{
